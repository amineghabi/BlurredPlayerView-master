 ...
 */
public class BlurredPlayerView extends View {
    ...
    public BlurredPlayerView(Context context) {
        super(context);
        init(context, null);
    }

    public BlurredPlayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BlurredPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BlurredPlayerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
